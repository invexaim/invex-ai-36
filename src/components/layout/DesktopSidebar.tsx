...
const DesktopSidebar = ({ sidebarItems, currentPath, theme, toggleTheme }: DesktopSidebarProps) => {
  return (
    <aside className="w-full md:w-64 border-l border-border bg-white text-gray-800 dark:bg-slate-900 dark:text-white hidden md:block fixed top-0 bottom-0 right-0 z-30">
